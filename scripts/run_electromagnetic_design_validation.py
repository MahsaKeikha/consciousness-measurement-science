...
def _render_svg(
  ...
  <text x="85" y="108" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">Point-spread and cross-talk, source distinguishability, information-aware sensor design,</text>
  <text x="85" y="132" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">nuisance projection, and robust model uncertainty.</text>
