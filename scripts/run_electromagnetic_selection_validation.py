...
def _render_svg(
  ...
  <text x="830" y="866" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#6b7785">Exact law: marginal_coverage^K under</text>
  <text x="830" y="887" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#6b7785">independent null coordinates.</text>

  <text x="85" y="944" font-family="Arial, Helvetica, sans-serif" font-size="14" fill="#6a7684">Analytic and fixed-seed synthetic inference. No human empirical data.</text>
