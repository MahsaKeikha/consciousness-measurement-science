...
def _render_svg(
  ...
  <text x="1110" y="68" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#26374d">Can significance survive multiplicity,</text>
  <text x="1110" y="84" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#26374d">selection, and an independent</text>
  <text x="1110" y="100" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#26374d">confirmation requirement?</text>
  ...
  <text x="830" y="875" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#3f5d45">Exact law: selected coverage = marginal coverage^K.</text>
