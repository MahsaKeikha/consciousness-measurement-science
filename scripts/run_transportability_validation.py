...
def _render_svg(
  ...
  <text x="85" y="106" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">Coordinate invariance, lossy projection, topography mismatch,</text>
  <text x="85" y="130" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">covariate-shift reweighting, and sharp transport budgets.</text>
