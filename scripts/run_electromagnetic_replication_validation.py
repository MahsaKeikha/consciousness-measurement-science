...
def _render_svg(
  ...
  <text x="150" y="570" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#526276">leave-one-site-out shift</text>
  <text x="735" y="570" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#294f64">delta_i = mu_hat(-i) - mu_hat</text>
