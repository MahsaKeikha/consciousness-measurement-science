...
def _render_svg(
  ...
  <text x="85" y="108" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">Common-effect pooling, heterogeneity, leave-one-site-out influence,</text>
  <text x="85" y="132" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">partial conjunction, and site-weight concentration.</text>
