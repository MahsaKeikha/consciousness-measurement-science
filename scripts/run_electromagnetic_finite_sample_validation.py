...
def _render_svg(
  ...
  <text x="1110" y="68" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#26374d">Do nominal electromagnetic inferences</text>
  <text x="1110" y="84" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#26374d">remain calibrated with finite samples,</text>
  <text x="1110" y="100" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#26374d">model mismatch, and multiple searches?</text>
  ...
  <text x="480" y="558" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#526276">equal-prior Bayes error</text>
  <text x="705" y="558" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#294f64">P(error) = Phi(-d/2)</text>
  ...
  <text x="1220" y="558" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#526276">two-sided z threshold</text>
  <text x="1490" y="558" text-anchor="end" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#43634a">FWER = 1 - [2 Phi(t) - 1]^K</text>
  ...
  <text x="124" y="878" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#365064">Finding: discrimination improves with covariance-aware separation.</text>
  <rect x="820" y="861" width="665" height="24" rx="8" fill="#f0f5ef" stroke="#d7e3d5"/>
  <text x="834" y="878" font-family="Arial, Helvetica, sans-serif" font-size="12" font-weight="700" fill="#3f5d45">Finding: multiplicity raises the required decision threshold.</text>
