...
def _render_svg(
  ...
  <text x="85" y="108" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">Efficient amplitude inference, inverse-covariance bias, Gaussian discrimination,</text>
  <text x="85" y="132" font-family="Arial, Helvetica, sans-serif" font-size="17" fill="#46586c">multiplicity control, and covariance-mismatch calibration.</text>
