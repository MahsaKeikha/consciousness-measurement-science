...
def _render_svg(
  ...
  <text x="1110" y="72" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#26374d">Do nominal electromagnetic inferences remain calibrated</text>
  <text x="1110" y="92" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#26374d">with finite samples, model mismatch, and multiple searches?</text>
  ...
  <text x="124" y="878" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#365064">Finding: source error falls only as covariance-aware separation increases.</text>
  <rect x="820" y="861" width="665" height="24" rx="8" fill="#f0f5ef" stroke="#d7e3d5"/>
  <text x="834" y="878" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#3f5d45">Finding: multiplicity requires a stricter threshold as the search space expands.</text>
