    ...
    *,
    ...
    parts = [
        ...
        svg_text(
            60,
            118,
            "Field quantities are measurable evidence channels.",
            size=15,
            fill="#657286",
        ),
        svg_text(
            60,
            140,
            "They are stress-tested for confounds before any interpretation.",
            size=15,
            fill="#657286",
        ),
    ...
    parts.extend(
        [
            ...
            svg_text(
                x0 + 26,
                y0 + 62,
                "A shared contaminant can create apparent phase organization",
                size=13,
                fill="#687588",
            ),
            svg_text(
    ...
    parts.extend(
        [
            ...
            svg_text(
                x0 + 26,
                y0 + 370,
                "Result: nuisance removal collapses the apparent organization",
                size=12,
                weight=600,
                fill="#4f5e72",
            ),
            ...
            svg_text(
                60,
                825,
                "Synthetic validation only. Electromagnetic structure is a candidate evidence channel.",
                size=12,
                fill="#697587",
            ),
            svg_text(
